          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className={`rounded-lg border p-6 ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  <h4 className={`font-medium mb-2 ${textClass}`}>Accuracy Metrics</h4>
                ...
                <div>
                  <h4 className={`font-medium mb-2 ${textClass}`}>Validation Methods</h4>
                  <div className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                ...
                <div>
                  <h4 className={`font-medium mb-2 ${textClass}`}>Continuous Improvement</h4>
                  <div className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div className={`p-4 rounded-lg border ${isDarkMode ? 'border-gray-600 bg-gray-700' : 'border-gray-200 bg-gray-50'}`}>
                  <h4 className={`font-medium mb-2 ${textClass}`}>🐠 Marine Conservation</h4>
